...
The output of this 'Shaner' 40106 VCO - or the input from an external 'X' source - is applied to the 'Divider_In' input of the SubHarmonic Dividers, the input stages of which provide a 0 : 5V pulse at node 'X' on the schematic. There is a detailed description of the derivation of this pulse signal, including
