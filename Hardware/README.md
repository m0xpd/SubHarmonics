...
The output of this 'Shaner' 40106 VCO - or the input from an external 'X' source - is applied to the 'Divider_In' input of the SubHarmonic Dividers, the input stages of which provide a 0 : 5V pulse at node 'X'. There is a dfetailed description of the derivation of this pulse signal, including a
descritption of options to set emitter resistor R19 to either maximise input sensitivity or enable a degree of noise immunity [here.](https://github.com/m0xpd/SubHarmonics/blob/main/Hardware/Graphics/Input%20Stage%20Switching%20Behaviour.md) 
